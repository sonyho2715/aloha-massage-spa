        ...
        <nav className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              <span className="text-xl font-semibold text-slate-900">Aloha</span>
              <span className="text-xl text-sky-600 ml-1">Massage Spa</span>
            </div>
          </Link>
        ...
        {isMenuOpen && (
          <div className="lg:hidden py-4 border-t border-slate-100">
            <div className="flex flex-col gap-2">
              ...
              <a
                href="tel:+18081234567"
                className="px-4 py-3 text-slate-600 hover:bg-slate-50 rounded-lg font-medium flex items-center gap-2"
              >
                <Phone className="w-4 h-4" />
                (808) 123-4567
              </a>
